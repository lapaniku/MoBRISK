...
void setParameters()
{
	...
	else if (dataset == UCF101)
	{
		...
		// MOFREAK_PATH = "/home/andrei/Desktop/MF";
		// VIDEO_PATH = "/home/andrei/Desktop/UCF-101";
		// SVM_PATH = "/home/andrei/Desktop/SVM";
		// METADATA_PATH = "/home/andrei/Desktop/UCF-101/metadata/";
		...
		MOFREAK_PATH = "/home/andrei/Desktop/fight-bow-tmp/MF";
		VIDEO_PATH = "/home/andrei/Desktop/Datasets/fight-flat/";
		SVM_PATH = "/home/andrei/Desktop/fight-bow-tmp/SVM";
		METADATA_PATH = "/home/andrei/Desktop/fight-bow-tmp/metadata/";
	}
...
void computeMoFREAKFiles()
{
	...
	for (directory_iterator dir_iter(VIDEO_PATH); dir_iter != end_iter; ++dir_iter)
	{
		if (is_regular_file(dir_iter->status()))
		{
			...
			string ext = video_filename.substr(video_filename.length() - 3, 3);
			if (ext == "avi" || ext == "mpg" || ext == "mp4")
			{
